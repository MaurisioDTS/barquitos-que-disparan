...
public class BoardController implements Initializable{
    ...
    Board elpepe=new Board("elpepe");
    
    Ship one=new Ship("portaaviones",5,0,0);
    Ship two=new Ship("buque telepata de guerra",4,0,1);
